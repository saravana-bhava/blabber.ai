DROP FUNCTION IF EXISTS get_feed_posts_with_interactions(text,integer,integer,text,text,text,text);
...
-- Add a new function specifically for explore tab that includes visual content
CREATE OR REPLACE FUNCTION get_explore_posts_with_interactions(
    p_current_user_id TEXT,
    p_limit INTEGER,
    p_offset INTEGER,
    p_filter_by_user_id TEXT DEFAULT NULL,
