-- Create engagement-ordered version for shorts
CREATE OR REPLACE FUNCTION get_shorts_posts_with_interactions(
...
-- Create engagement-ordered version for explore
CREATE OR REPLACE FUNCTION get_explore_posts_with_interactions_engagement(
    p_current_user_id TEXT,
    p_limit INTEGER,
    p_offset INTEGER,
    p_filter_by_user_id TEXT DEFAULT NULL,
